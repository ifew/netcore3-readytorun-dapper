...
#cp bin/Release/netcoreapp3.0/linux-x64/publish/netcore3-readytorun-dapper bootstrap
#chmod 777 bootstrap
#zip package.zip bootstrap
cp bin/Release/netcoreapp3.0/linux-x64/publish/netcore3-readytorun-dapper bin/Release/netcoreapp3.0/linux-x64/publish/bootstrap
